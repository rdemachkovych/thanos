...
const (
	...
	demoNewView = "/graph?g0.expr=%7Bis%3D\"thanos-with-new-promql\"%7D&g0.tab=1&g0.stacked=0&g0.range_input=2d&g0.max_source_resolution=0s&g0.deduplicate=1&g0.partial_response=0&g0.store_matches=%5B%5D&g0.end_input=2019-09-19%2000%3A00%3A00&g0.moment_input=2019-09-19%2000%3A00%3A00&g0.step_input=700&g1.expr=count(cluster_version%7Bfrom_version%3D\"4.1.9\"%7D)%20%2F%20count(cluster_version)-&g1.tab=0&g1.stacked=0&g1.range_input=1d&g1.max_source_resolution=0s&g1.deduplicate=1&g1.partial_response=0&g1.store_matches=%5B%5D&g1.end_input=2019-09-19%2000%3A00%3A00&g1.moment_input=2019-09-19%2000%3A00%3A00&g1.step_input=300&g2.expr=&g2.tab=1&g2.stacked=0&g2.range_input=1h&g2.max_source_resolution=0s&g2.deduplicate=1&g2.partial_response=0&g2.store_matches=%5B%5D"
...
func TestQueryStore_Macrobench(t *testing.T) {
	...
	{
		const image = "thanos:demo-26-10-22-v2"
		// "thanos:25-10-22-main-pq-main" // current main.
